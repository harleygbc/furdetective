...
$(document).ready(function () {
  ...
  var right_side_views =
    '<div className="right-side-views d-none">' +
    '<ul className="sticky-sidebar siderbar-view">' +
    '<li className="sidebar-icons">' +
    '<a className="toggle tipinfo open-layout open-siderbar" href="javascript:void(0);" data-toggle="tooltip" data-placement="left" data-bs-original-title="Tooltip on left">' +
    '<div className="tooltip-five ">' +
    '<img src="assets/img/icons/siderbar-icon2.svg" className="feather-five" alt="">' +
    ...
    "</div>" +
    '<div className="col-xl-6 col-sm-6 col-12">' +
    '<a className="btn-closed" href="javascript:void(0);"><img className="img-fliud" src="assets/img/icons/sidebar-delete-icon.svg" alt="demo"></a>' +
    "</div>" +
    "</div>" +
    "</div>" +
    "</div>" +
    ...
    '<img className="img-fliud" src="assets/img/demo-one.png" alt="demo">' +
    "</div>" +
    '<div className="row">' +
    '<div className="col-lg-6 layout">' +
    '<h5 className="layout-title">Dark Mode</h5>' +
    "</div>" +
    '<div className="col-lg-6 layout dark-mode">' +
    '<label className="toggle-switch" for="notification_switch3">' +
    "<span>" +
    '<input type="checkbox" className="toggle-switch-input" id="notification_switch3">' +
